...
// const pushOrderForSync = async (order, client, database, offlineMode) => {
//
//
//   console.log("pushOrderForSync offlineMode: ", offlineMode)
//   try {
//     if (order.payment_method === "rfid" && !offlineMode) {
...
//     }
//
//     if (order.payment_method === "credit" && !offlineMode) {
...
//     }
//
//     if (order.payment_method === "cash" && !offlineMode) {
//       const currentTime = moment(
//         moment(new Date().toUTCString(), "DD MMM YYYY HH:mm:ss").format(
//           "YYYY-MM-DDTHH:mm:ss"
//         )
...
// };
//
// export const syncOrders = async (client, database, offlineMode) => {
//   console.log("SyncOrders OfflineMode: ", offlineMode);
//   try {
...
//           });
//         } else {
//           await pushOrderForSync(order, client, database, offlineMode);
//         }
//       });
