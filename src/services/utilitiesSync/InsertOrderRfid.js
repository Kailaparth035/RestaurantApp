 ...
 * @returns
 */
export async function insertOrderRfid(
  orderInputs,
  extraPayload,
  database,
  is_online
  ...
  try {
    ...
    WriteLog("insertOrderRfid rfid order tax" + orderInputs);
    console.log("rfid order tax", orderInputs);
    ...
    WriteLog("insertOrderRfid [WATERMELON_DB] RFID Order Insert :" + error);
    console.log(`[WATERMELON_DB] RFID Order Insert :`, error);
    return error;
  }
}
